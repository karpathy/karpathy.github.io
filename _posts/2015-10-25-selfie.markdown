...
3. Now it is time to decide which ones of those selfies are good or bad. Intuitively, we want to calculate a proxy for how many people have seen the selfie, and then look at the number of likes as a function of the audience. I took all the users and sorted them by their number of followers. Then I marched down this sorted list in groups of 100, and sorted those 100 people's selfies based on the number of likes. I took the better half 50 and assigned them as positive selfies, and I took the worse half 50 and assigned those to negatives. What we end up with is a binary split of the data into two halves, where we try to normalize by the number of people who have probably seen the selfie. In this process I also filtered people with too few followers or too many followers, and also people who used too many tags on the image (which in many cases were spam, and which may have inflated the visibility of the images too much beyond their number of followers).
